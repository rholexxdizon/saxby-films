...
const About = () => {
  ...
  // Our Story observer - triggers when hero is out of view and story comes into view
  const [storyRef, storyInView] = useInView({
    threshold: isMobile ? 0.2 : 0.3,
    triggerOnce: false,
  })

  // Meet Your Filmmaker observer - triggers when story is out of view
    ...
    <section id="about" className="py-24 md:py-32 px-6 md:px-12 bg-saxby-surface transition-colors duration-300">
      <div className="max-w-[1400px] mx-auto">
        ...
        <motion.div
          ...
          transition={{ duration: isMobile ? 0.5 : 0.8, delay: isMobile ? 0.2 : 0.3, ease: [0.25, 0.1, 0.25, 1] }}
        ...
        >
          ...
          <div>
            ...
            <motion.div
              ...
              transition={{ duration: isMobile ? 0.5 : 0.8, delay: isMobile ? 0.3 : 0.5, ease: [0.25, 0.1, 0.25, 1] }}
          ...
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            animate={activeSection === 'hero' ? { opacity: 1, x: 0 } : { opacity: 0, x: 50 }}
            transition={{ duration: isMobile ? 0.5 : 0.8, delay: isMobile ? 0.25 : 0.4, ease: [0.25, 0.1, 0.25, 1] }}
          >
            <MasonryGallery />
          </motion.div>
        </motion.div>
        ...
        <div ref={storyRef} className="mb-16 relative">
          ...
          >
            ...
            <motion.div
              ...
              transition={{ duration: isMobile ? 0.5 : 0.8, delay: 0.1, ease: [0.25, 0.1, 0.25, 1] }}
              className="relative"
            >
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <motion.div
                ...
                transition={{ duration: isMobile ? 0.6 : 0.8, delay: 0.2, ease: [0.25, 0.1, 0.25, 1] }}
              ...
              <motion.div
                ...
                transition={{ duration: isMobile ? 0.6 : 0.8, delay: 0.15, ease: [0.25, 0.1, 0.25, 1] }}
